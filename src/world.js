...
export const SIZE=112,START={x:12,y:43},BOSS_POS={x:78,y:27};
...
for(let x=8;x<SIZE-5;x+=5)for(let y=8;y<SIZE-5;y+=5){
 if(terrainBase(x,y)!=='grass'||isTrail(x,y)||metric({x,y},START)<5||metric({x,y},BOSS_POS)<8||hash(x+99,y)>.68)continue;
